---
title: "Should You Overpay Your Mortgage? A Country-by-Country Take"
description: "Should you overpay your mortgage in 2026? The answer hinges on two numbers most guides skip: the rate gap to your savings, and your country's prepayment cap."
excerpt: "The textbook advice — overpay when your mortgage rate beats your savings rate — misses the number that actually decides it: the legal cap on prepayment penalties in your country."
slug: "should-you-overpay-your-mortgage"
canonicalSlug: "overpay-your-mortgage"
...
|---|---|
| **Spain** | Fixed: 2% (years 1–10), 1.5% after. Variable: 0.25% (years 1–3), 0.15% (years 3–5), 0% after. Bank must also prove actual financial loss. ([Banco de España](https://clientebancario.bde.es/pcb/es/menu-horizontal/productosservici/relacionados/comisiones/comisionesproduc/compensacion-o-comision-por-reembolso-o-amortizacion-anticipada-total-o-parcial.html)) |
...
| **Portugal** | Variable: 0.5% (the 2022–2025 exemption **ended 31 December 2025**). Fixed: 2%. ([DL 74-A/2017](https://pgdlisboa.pt/leis/lei_mostra_articulado.php?nid=2842&so_miolo=&tabela=leis)) |
...
Overpay when the interest rate on your mortgage, **after any tax relief you receive on mortgage interest**, is higher than the after-tax return on where the money would otherwise sit. In April 2026 that describes almost every euro-area borrower, because ECB rates have fallen faster than mortgage contracts have repriced ([ECB monetary policy, February 2026](https://www.ecb.europa.eu/press/pr/date/2026/html/ecb.mp260205~001d26959b.en.html)). But the rule only applies once three preconditions are in place.
...
**3. No tax-advantaged alternative that out-earns the mortgage after tax.** UK ISAs and LISAs, French PEA and assurance-vie, Dutch *box 3* exempt savings, Portuguese PPR, German Riester. If one of these offers a post-tax return above your mortgage rate, it beats the overpayment — including for safety, because you keep access to the money. The MoneySavingExpert guide covers the UK case in detail ([Mortgages vs. savings — MoneySavingExpert](https://www.moneysavingexpert.com/mortgages/mortgages-vs-savings/)).
...
This is exactly why CasaTab's mortgage module supports extra repayments as first-class entries with a recalculated schedule — so you can see what a €5,000 overpayment actually buys you (or doesn't) before you send the money, and compare a term-reduction scenario against a payment-reduction one side by side. [Model it in CasaTab](https://casatab.com) and the overpayment becomes a decision with a number on it, not a feeling.
...
For a wider view of where mortgage payments sit inside the broader cost of owning a home, the [true cost of buying a house](/blog/true-cost-of-buying-a-house/) breaks down every fee that sits around the loan itself.
